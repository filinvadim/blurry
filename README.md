...
go test -v -timeout=2h -count=1  -run TestBench .
    ...
    bench_test.go:226: [blurry] bringing stack up via blurry/bench/docker-compose.blurry.yml (project=bench-blurry)
    ...
    bench_test.go:226: [chotki] bringing stack up via blurry/bench/docker-compose.chotki.yml (project=bench-chotki)
