...
go test -v -timeout=2h -count=1  -run TestBench .
    ...
    bench_test.go:340: [blurry] processed 1000 x 64 KiB through write→sync→read in 3.70783625s (269.7 req/s, 16.86 MiB/s)
    ...
    bench_test.go:340: [chotki] processed 1000 x 64 KiB through write→sync→read in 42.476456209s (23.5 req/s, 1.47 MiB/s)
